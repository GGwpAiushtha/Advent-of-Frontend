...
In this project, we're going to create sign-up form with validation.
...
- Add additional form fields. Including a custom checkbox or a custom radio button.
- Try adding interactivity to the form with JavaScript. If you get stuck, be sure to check out the [Advent of JavaScript](http://adventofjavascript.com).
